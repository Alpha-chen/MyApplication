...
public class BasePresenter<V extends BaseView> {
     ...
     */
    private static final InvocationHandler NULL_VIEW = new BasePresenter.MvpViewInvocationHandler();
    /**
     * application context
     */
    ...
    static {
        try {
            ...
            Application application =
                    (Application) Class.forName("android.app.ActivityThread").getMethod
            ...
            if (sAppContext == null) {
                // 第二种方式初始化
                application =
                        (Application) Class.forName("android.app.AppGlobals").getMethod("getInitialApplication")
     ...
     * @return
     */
    public static <V> V createView(Class<V> viewClz) {
        return (V) Proxy.newProxyInstance(viewClz.getClassLoader(),
